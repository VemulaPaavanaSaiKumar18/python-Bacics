...
user_str = position.lower()
pos1 = user_str[0]
pos2 = user_str[1]
alpha = ["a","b","c"]
h_index = 0
if(alpha[0] == pos1 or alpha[0] == pos2):
	h_index = 0
elif(alpha[1] == pos1 or alpha[1] == pos2):
	h_index = 1
elif(alpha[2] == pos1 or alpha[2] == pos2):
	h_index = 2

print(pos1, pos2, h_index)
if pos2.isdigit():
	map[int(pos2)-1][h_index] = "X"
else:
	map[int(pos1)-1][h_index] = "X"
